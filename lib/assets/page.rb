...
@doc=Nokogiri::HTML(File.read("./pages.html"))

@doc.css(".list-links.list-links-green li a, nav .menu li .sub-menu li a, nav .menu li .sub-menu li ul li a").each do |link|
